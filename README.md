...
| # | Message | Author |
|---|---------|--------|
| 1 | Initial commit | Steve Christian Hector OUEDRAOGO |
| 2 | Initial commit : initializing the global Hospital Management System project tree | Steve Christian Hector OUEDRAOGO |
| 3 | Add patient.py: Patient, UrgentPatient, HospitalizedPatient classes | Steve Christian Hector OUEDRAOGO |
| 4 | Fix calculate_fess bug in Patient.py and Fix encapsulation issues by restricting direct attribute access | Steve Christian Hector OUEDRAOGO |
| 5 | feat: add pharmacy script | ouedraogonancy-hue |
| 6 | feat: add pharmacy script | ouedraogonancy-hue |
| 7 | Delete modules/pharmacy.py | ouedraogonancy-hue |
| 8 | Rename pharmacy.py to modules/pharmacy.py | ouedraogonancy-hue |
| 9 | add the content of laboratory script | OUEDRAOGO Guétawende Reymond |
| 10 | Improve the global Hospital Management tree by adding folders | Steve Christian Hector OUEDRAOGO |
| 11 | Simplification of the class Patient for more efficiency | Steve Christian Hector OUEDRAOGO |
| 12 | Refactor Doctor class to include specialty and remove unused methods | Steve Christian Hector OUEDRAOGO |
| 13 | Refactor laboratory module to improve documentation and standardize messages | Steve Christian Hector OUEDRAOGO |
| 14 | Implement EmergencyRoom class with patient queue management and status display | Steve Christian Hector OUEDRAOGO |
| 15 | Add CLI utility functions for user input and display | ratouswendeirene-lgtm |
| 16 | Implement storage functions for patients, staff, and invoices with JSON and CSV support | ouedraogohanifah01-afk |
| 17 | Implement patient and staff management menus with admission and treatment functionalities | hortensekabore |
| 18 | Refactor MedicalPersonnel and subclasses | Steve Christian Hector OUEDRAOGO |
| 19 | Refactor Patient class with private attributes | Steve Christian Hector OUEDRAOGO |
| 20 | Update menus.py | OUEDRAOGO Rafa Nancy |
| 21 | Rename bills.csv to bills.json | OUEDRAOGO Rafa Nancy |
| 22 | Update Billing script | OUEDRAOGO Rafa Nancy |
| 23 | Refactor import statements to use modules instead of services | Steve Christian Hector OUEDRAOGO |
| 24 | Update main.py | OUEDRAOGO Rafa Nancy |
| 25 | Update the readme | ouedraogohanifah01-afk |
| 26 | Update README.md | ouedraogohanifah01-afk |
| 27 | Update storage.py | hortensekabore |
| 28 | Update storage.py | hortensekabore |
| 29 | Update pharmacy.py | OUEDRAOGO Rafa Nancy |
| 30 | Add billing records and update doctor and patient data | Steve Christian Hector OUEDRAOGO |
